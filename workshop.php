...
<a href="showroom.php" style="color:#000">
                        ...
                        <div class="navbar-collapse collapse clearfix">                                                                                              
                            <ul class="navigation">
                               ...
                               <li class=""><a href="showroom.php">Showroom</a> </li>
                                <li class="current"><a href="workshop.php">Workshop</a> </li>
    ...
    <!-- Page Banner  -->
    <section class="page-banner" style="background-image:url(images/contact.jpg);">
         <div class="auto-container">
    ...
    <div class="sidebar-page">
    	<div class="auto-container">
            <div class="row clearfix">
                ...
                <!-- Side Bar -->
                <aside class="side-bar col-lg-7 col-md-7 col-sm-7 col-xs-12">
                    <img src="images/Tata-Hexa-at-showroom.jpg" class="img-responsive">                
                
                </aside>
            
                <!-- Left Content -->
                 <section class="left-content col-lg-4 col-md-4 col-sm-4 col-xs-12">
                	
                    
                    <!-- Contact Form -->
                    <div class="contact-form ">
                			
                        <div class="sec-title"><h3 class="skew-lines">Fill-in to get a call back</h3></div>
                        <?php
							...
							$subject = "Get A Call Back from Hartron Motors";
							
							$message = "
							<html>
							<head>
							<title>Get A Call Back Detail</title>
							</head>
							<body>
							
							<table>
							<p align='center'>Get A Call Back Detail</p>
							<tr>
							...
							{
								echo "<p style='color:green;padding:5px;font-size:23px;'>submitted successfully</p>";
								//header("location:/destination.html?msg=success");
								header( "refresh:5;url=http://eazysoftech.com/car-dealer/online-booking.php" );
							}
							else
							{
							...
							?> 
                        <!--Contact Form-->
                        <form id=" "  class="col-md-12"method="post" action="#">
                            <div class="row clearfix">
                                    ...
                                    <div class="form-group">
										...
										<option> Tata Zest  </option>
										<option> Tata Hexa </option>
										<option> Tata Safari Storme </option>
										<option>  Tata Safari Dicor </option>
										<option>Tata Bolt  </option>
										<option> Tata Nano </option>
										<option>Tata Indica  </option>
										<option> Tata Indigo CS </option>
										<option> Tata Xenon </option>
                                    ...
                                    <div class="form-group">
                                         <input type="text" name="csubject"  placeholder="Enter a Subject">
                                    </div>
                                    <div class="form-group">
                                         <input type="text" name="mobile" pattern="[789][0-9]{9}" title="Only mobile number " required  placeholder="Enter a Mobile No" maxlength="10">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-group text-right">
                                <div class="theme-btn dark-btn hvr-bounce-to-right">
                            <span class="fa fa-envelope"></span>
                                <input type="submit" name="submit" style="background:#36404b;" value="Submit"  />
                                </div>
                            </div>
                ...
                <!-- Left Content -->
                <section class="side-bar col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    
                     
                    
                    <!-- Contact Info -->
                    <div class="widget cont-info">
                        <div class="sec-title"><h3 class="skew-lines">Contact Workshop</h3></div>
                        <div class="cont-box">
                             <ul class="info">
                                <li class="blue-color"><strong>Address</strong> <a href="https://goo.gl/maps/GZAqF2PgDxG2" target="_blank"> Plot No. 34, Sector-18, Industrial Estate, Gurugram-122008, Haryana, India.</a></li>
                            	<li class="blue-color"><strong>Email</strong> &nbsp;&nbsp;&nbsp;&nbsp; <a href="mailto:service@hartronmotors.com;">service@hartronmotors.com;</a></li>
                                <li><strong>Phone</strong> &nbsp;&nbsp; <span class="blue-color">+91-9717174444</span></li>
                             </ul>
                        </div>
