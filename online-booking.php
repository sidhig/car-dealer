...
<a href="showroom.php" style="color:#000">
                        ...
                        <div class="navbar-collapse collapse clearfix">                                                                                              
                            <ul class="navigation">
								...
								<li><a href="up.php">UP Registration</a></li> 
                                 ...
                                 <li  class="dropdown current"><a href="#">Online Booking</a>
								<ul class="submenu">
    ...
    <!-- Page Banner-->
    <section class="page-banner" style="background-image:url(images/TATA_TIGOR_REAR-3-4TH-SHOT_LAYERED111111.jpg);">
         <div class="auto-container">
        	...
        	<div class="row">
                ...
                <div class="tabs-box clearfix">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 tabs-content clearfix">
                        ...
                        <div class="sec-title"><h3 class="skew-lines">Test Drive Booking</h3></div>
                         <?php
							...
							$subject = "Test drive booking from Hartron Motors";
							...
							<table>
							<p align='center'>Booking Detail</p>
							<tr>
							<th>Model</th><td>$model</td>
							</tr>
							<tr>
							<th>Preferred date</th><td>$pdate</td>
							</tr>
							<tr>
							...
							{
								echo "<p style='color:green;padding:5px;font-size:23px;'>Booking submitted successfully</p>";
                        ...
                        <form id=" " method="post" action="">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">Choose Your Model</label>
										<select required name="model" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" required name="pdate" id="datepicker"  placeholder="DD/MM/YEAR">
                                    </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" required name="city" required  placeholder="Enter Your City">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Time Slot</label>
                                       <input type="text" pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" title="Only Time format allow. ex: 11:15 " required name="time" placeholder="Enter Desired Time For Test Drive">
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[789][0-9]{9}" title="Only mobile number " required name="mobile" placeholder="Enter Your Mobile No." maxlength="10">
                                    </div> 
                            ...
                            <span class="fa fa-envelope"></span>
                                <input type="submit" name="submit" style="background:#36404b;" value="Book"  />
                                </div>
                            </div>
